...
const LABEL: Record<AuditAction, string> = {
  ...
  "dns-changed": "Changed DNS",
  "app-domain-changed": "Changed an application domain",
  "app-created": "Created an application",
  "app-cache-purged": "Cleared a server cache",
  "app-deleted": "Deleted an application",
  "app-cloned": "Cloned an application",
  "website-created": "Started a website",
  "website-edited": "Edited a website",
  "website-restored": "Restored an earlier version",
  ...
  "domain-buying": "Started buying a domain",
  "domain-bought": "Bought a domain",
  "prompt-saved": "Changed a site’s instructions",
  "permissions-changed": "Changed what somebody can do",
  "prompt-deleted": "Removed a site’s instructions",
  "pagetype-saved": "Saved a page type",
  "pagetype-deleted": "Deleted a page type",
  ...
  "mail-unpaid": "Unmarked an invoice",
...
const TONE: Record<AuditAction, string> = {
  ...
  "keys-updated": "warn",
  "dns-changed": "warn",
  "app-domain-changed": "warn",
  "app-created": "run",
  "app-cache-purged": "idle",
  "app-deleted": "bad",
  "app-cloned": "run",
  "website-created": "run",
  "website-edited": "idle",
  "website-restored": "idle",
  "website-published": "ok",
  "website-deleted": "bad",
  ...
  "domain-bought": "ok",
  "prompt-saved": "ok",
  "permissions-changed": "warn",
  "prompt-deleted": "warn",
  "pagetype-saved": "ok",
  "pagetype-deleted": "warn",
  "mail-sent": "run",
  "mail-replied": "run",
  "mail-forgotten": "idle",
  "mail-campaign": "run",
