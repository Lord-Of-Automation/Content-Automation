...
export default function DomainCheck() {
  ...
  // The same flow the generator uses. A purchase that charges a card should
  // exist once, so a fix to it is a fix in both places.
  const { buy, buying, bought } = useBuyDomain(push);
